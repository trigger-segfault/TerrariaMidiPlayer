		...
		public TriggerMessageBox(MessageIcon icon, string title, string message, MessageBoxButton buttons, string buttonName1 = null, string buttonName2 = null, string buttonName3 = null) {
			...
			switch (icon) {
				case MessageIcon.Info:
					this.Icon = new BitmapImage(new Uri("pack://application:,,,/TerrariaMidiPlayer;component/Resources/Icons/InfoIcon.png"));
					break;
				case MessageIcon.Question:
					this.Icon = new BitmapImage(new Uri("pack://application:,,,/TerrariaMidiPlayer;component/Resources/Icons/QuestionIcon.png"));
					break;
				case MessageIcon.Warning:
					this.Icon = new BitmapImage(new Uri("pack://application:,,,/TerrariaMidiPlayer;component/Resources/Icons/WarningIcon.png"));
					break;
				case MessageIcon.Error:
					this.Icon = new BitmapImage(new Uri("pack://application:,,,/TerrariaMidiPlayer;component/Resources/Icons/ErrorIcon.png"));
					break;
			}
